...
using System.IO;
using GoogleMerchant.Service.Authentication;
...
namespace GoogleMerchant.Service
{
    ...
    internal abstract class BaseService
    {
        ...
        internal class Options
        {
            ...
            [Option('p', "config_path", HelpText = "Configuration directory for Shopping samples.")]
            public string ConfigPath { get; set; }
            [Option('n', "noconfig", Default = false, HelpText = "Run samples without a configuration directory.")]
