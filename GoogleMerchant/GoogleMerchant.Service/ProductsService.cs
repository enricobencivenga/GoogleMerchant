...
namespace GoogleMerchant.Service
{
    ...
    public class ProductsService
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="ProductsService"/> class.</summary>
        ...
        public ProductsService(ShoppingContentService service, int maxListPageSize)
        {
                ...
                if (productsResponse.Resources != null && productsResponse.Resources.Count != 0)
                {
                    foreach (var product in productsResponse.Resources)
                    {
                        Console.WriteLine(
                            ...
                            product.Id,
                            product.Title);
                        shoppingUtilities.PrintWarnings(product.Warnings);
                    }
                }
                else
                {
        ...
        private void UpdateProduct(ulong merchantId, String productId)
        {
            ...
            Console.WriteLine(
                ...
                response.Id,
                response.Title);
            shoppingUtilities.PrintWarnings(response.Warnings);
            Console.WriteLine();
        }
        ...
        internal Product GenerateProduct(string websiteUrl)
        {
            ...
            product.OfferId = String.Format("product#{0}", shoppingUtilities.GetUniqueId());
